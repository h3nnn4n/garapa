...
void emulate_SUB(_cpu_info *cpu) {
    ...
    switch (cpu->opcode) {
        case 0x90: answer -= (uint16_t)cpu->b; break;
        case 0x91: answer -= (uint16_t)cpu->c; break;
        case 0x92: answer -= (uint16_t)cpu->d; break;
        case 0x93: answer -= (uint16_t)cpu->e; break;
        case 0x94: answer -= (uint16_t)cpu->h; break;
        case 0x95: answer -= (uint16_t)cpu->l; break;
        case 0x96: answer -= (uint16_t)read_byte_with_tick(cpu, read_hl(cpu)); break;
        case 0x97: answer -= (uint16_t)cpu->a; break;
        default: assert(0 && "Code should not get here\n");
    }
