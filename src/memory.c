    ...
    switch (addr) {
        case 0xff00: {
            ...
            if (cpu->joystick.select_button == 0) {
                input = (cpu->joystick.button_start << 3) | (cpu->joystick.button_select << 2) |
                        (cpu->joystick.button_b << 1) | (cpu->joystick.button_a << 0);
            }

            if (cpu->joystick.select_direction == 0) {
                input = (cpu->joystick.button_down << 3) | (cpu->joystick.button_up << 2) |
                        (cpu->joystick.button_left << 1) | (cpu->joystick.button_right << 0);
            }
            return 0xc0 | (input);
        }
        case 0xff01: return 0x00;
        case 0xff02: return 0x7e;
        case 0xff0f: return interrupt_read_IF(cpu);
        case 0xff04: // DIV
            return read_DIV(cpu);
        case 0xff05: // TIMA
        ...
        case 0xff41: return display_read_stat(cpu);
        case 0xff42: return read_scroll_y(cpu);
        case 0xff43: return read_scroll_x(cpu);
        case 0xff44: return display_read_LY(cpu);
        case 0xff45: // LCY
            return display_read_LYC(cpu);
        case 0xff4a: return read_window_y(cpu);
        case 0xff4b: return read_window_x(cpu);

        case 0xff10: return 0 | 0x80;
        case 0xff1a: return 0 | 0x7f;
        case 0xff1c: return 0 | 0x9f;
        case 0xff20: return 0 | 0xc0;
        case 0xff23: return 0 | 0x3f;
        case 0xff26: return 0 | 0x70;
        ...
        case 0xff27:
        case 0xff28:
        case 0xff29: return 0 | 0xff;

        case 0xffff: return interrupt_read_mask(cpu);
...
uint16_t read_word(_cpu_info *cpu, uint16_t addr) { return read_byte(cpu, addr + 1) << 8 | read_byte(cpu, addr + 0); }

uint16_t read_next_word(_cpu_info *cpu) { return read_word(cpu, cpu->pc + 1); }
...
void write_byte(_cpu_info *cpu, uint16_t addr, uint8_t data) {
    ...
    switch (addr) { // WRITE
        ...
        case 0xff41: // lcd stat
            ...
            break;
        case 0xff42: write_scroll_y(cpu, data); break;
        case 0xff43: write_scroll_x(cpu, data); break;
        case 0xff44:
            // LY is read only
            return;
        case 0xff45:
        ...
        case 0xff49: // sprite Palette 2
            ...
            break;
        case 0xff4a: write_window_y(cpu, data); break;
        case 0xff4b: write_window_x(cpu, data); break;
