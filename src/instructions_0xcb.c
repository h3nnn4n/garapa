...
void decode_0xcb(_cpu_info *cpu) {
    ...
    void (*f1[])(_cpu_info *, uint8_t) = {emulate_RLC, emulate_RRC, emulate_RL,   emulate_RR,
                                          emulate_SLA, emulate_SRA, emulate_SWAP, emulate_SRL};

    void (*f2[])(_cpu_info *, uint8_t, uint8_t) = {NULL, emulate_BIT, emulate_RES, emulate_SET};
